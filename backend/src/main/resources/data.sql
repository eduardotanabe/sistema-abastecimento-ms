...
INSERT INTO cidade (nome, id_estado_fk) 
VALUES 
('Dourados', 1),
('Campo Grande', 1),
('Naviraí', 1),
...
INSERT INTO modelo (descricao, id_marca_fk) 
VALUES 
('Duster', 10),
('Sandero', 10),
('Logan', 10),
...
INSERT INTO autoposto (nome_fantasia, telefone, email, cnpj, endereco, id_cidade_fk) 
VALUES 
...
INSERT INTO veiculo (ano, placa, renavam, patrimonio, chassi, versao, capacidade_tanque, tipo_combustivel, id_tipo_fk)
VALUES 
...
INSERT INTO lotacao (descricao, email, site, telefone, endereco, id_cidade_fk)
VALUES 
